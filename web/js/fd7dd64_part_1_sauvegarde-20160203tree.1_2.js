...
Tree.prototype.drawNodes = function(nodes, source){
 ...
 //<img src="{{ 'bundles/ophfamilytree/images/pas-d-avatar.png' | imagine_filter('my_thumb') }}"
  ...
  nodeEnter.append("a")
    .attr("xlink:href", function(){ return Routing.generate('oph_familytree_view', { id: d.id }); } )
